import { parseLineData } from '../src/graphs/line'
import { parseCandleData } from '../src/graphs/candle'
...
describe('Data Driver', () => {
  it('line data format', () => {
    ...
    expect(parseLineData(testData)).toEqual(({
      data: [3283.86, 3293.6, 3311.95, 3289.36, 3254.69, 3278.93, 3274.17, 3331.69, 3326.76,
        3286.14, 3310.41, 3267.49],
      minValue: 1234.56,
      maxValue: 3331.69,
      klass: 'quote-up',
    }))
